...
| Rare Lanternjaw lineage | [All11 birth-producing mutation-site replays](7_Research/hunter-juvenile-flow-cohort-2026-09-13.md) cover18 paid offspring with zero growth; corrected intake facts and complete-cohort checks pass [independent review](7_Research/juvenile-cohort-correction-independent-review-2026-09-13.md) | Astra's [size-aware paid-growth gate](7_Research/astra-hunter-size-aware-growth-proposal-2026-09-13.md) selected for isolated implementation and one matched seed pilot; full-cohort review precedes hunter24/72h or live introduction. No fixed-intake arithmetic presented as a counterfactual |
