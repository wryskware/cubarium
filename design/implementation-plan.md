...
| Fragile fauna/diversity | [Completed seed1/2 flow pilots](7_Research/fauna-development-flow-diagnostic-2026-09-13.md) report exact baseline/observer identities and full member accounting; most skimmers mature, but seed2 recruitment stops before extinction | Independent recovery/pilot review underway before remaining10seed launch. Funding-site success does not rule out controller stock eligibility; one extinction does not explain all8. Preserve interrupted smoke history, no tuning yet |
